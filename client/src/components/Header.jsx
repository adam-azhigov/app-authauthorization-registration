                ...
                <div className=' bg-red-500 px-3  leading-[56px] md:flex justify-around'>
                    ...
                    bg-red-500 z-10   left-0 w-full md:w-auto  
                     transition-all duration-700 ease-in ${open ? '  top-[58px] opacity-100' : '  top-[-160px]'  } `}>
                       <div>
                          <Link to='/users'  className={'hover:border-b-2 border-amber-400 text-gray-700 font-[Verdana] md:ml-4 active:text-white  focus:text-white'}> Пользователи</Link>
                       </div>
                        <div>
                            <Link to='/current' className={'hover:border-b-2 border-amber-400 cursor-pointer  text-gray-700 font-[Verdana] md:ml-4 active:text-white  focus:text-white '} > Личный кабинет</Link>
                        </div>
                        <div>
